...
void main() {
	pid_t pidP2, pidP3;/*Crear 2 variables para guardar el 
	pid de los hijos de P1*/
	...
	if(pidP2==0)
	{
		...
		sleep(10);
		printf("Despierto\n");
		/*Si estamos en el proceso P2 duerme 10 segundos y 
		muestra el mensaje "Despierto"*/
	}
	else
	{
		...
		if(pidP3==0){
			...
			wait(NULL);
			/*Si estamos en el proceso P1 espera a que 
			termine su hijo P3*/
		}		
	}
